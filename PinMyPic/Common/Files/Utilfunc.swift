...
func configureCollectionVewLayout (scrollDirection :  UICollectionView.ScrollDirection = .vertical, numberofItemInrow : Int, cellIneterSpacing : CGFloat = 10, sectionSpacing :  CGFloat = 30, totalWidth : CGFloat? = nil ,height: CGFloat? = nil) -> UICollectionViewLayout{
    ...
    let availableWidth = (totalWidth ?? UIScreen.main.bounds.width) - (cellIneterSpacing*numberofItemInrow) - inset.left - inset.right
